...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editCommentModal<?php echo $comment['comment_id']; ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editCommentModalLabel<?php echo $comment['comment_id']; ?>">Edit Comment</h1>
        ...
        <form method="post" action="">
              ...
              <div class="mb-3">
                <label for="cDesc <?php echo $comment['comment_id']; ?>" class="form-label">Comment</label>
                  <input type="text" class="form-control" id="cDesc<?php echo $comment['comment_id']; ?>" name="cDesc" value ="<?php echo $comment['comment_txt']; ?>">
              </div>
